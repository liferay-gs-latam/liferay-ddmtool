...
var coTemplate = function (file) {
	...
	console.log("identifyingSingleFilePath: " + identifyingSingleFilePath);
	console.log("identifyingDoubleFilePath: " + identifyingDoubleFilePath);
...
//		newObj.classNameId = LrClassNameConfig.getSingleValue('clazz', possibleClassNames[0].structure, 'id');
	...
	if (!newObj.isADT) { // If "normal" template, such as journal or ddm
		...
		console.log("newObj.validStructures = " + newObj.validStructures);
	...
	// console.log(JSON.stringify(Templates.getAllFilter()));
	// console.log(JSON.stringify(Templates.fetch()));
	...
	// if(newObj.classNameId == "33717") console.log("newObj = " + JSON.stringify(newObj));
