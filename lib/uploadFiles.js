...
function createUploadObject(file) {
	...
	// console.log("firing createUploadObject");
...
var preparePayloads = function (i, files, whenFinishedUploadingCallback) {
	...
	// console.log("Firing preparePayloads");
	...
	createUploadObject(files[i]).then(function (e){
		...
		if(i < files.length-1) {
			...
			// console.log("Firing preparePayloads i < files.length-1");

			preparePayloads(++i, files);
		} else {

			console.log("Firing preparePayloads ELSE");
