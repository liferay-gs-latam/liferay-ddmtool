...
var createUploadObject = function (newObj) {
	...
	getSite(newObj, returnObj)
		.then(function (currentSite) {
			...
			returnObj.group.name			= Sites.getSingleValue('groupId', currentSite.site, 'descriptiveName');
			...
			// TODO: how to auto-detect the default local from the structure definition
			var defaultLocale = { language: 'en', country: 'US' };
			...
			returnObj.payload = '{"/ddm.ddmstructure/add-structure": ' + JSON.stringify(payload) + '}';
